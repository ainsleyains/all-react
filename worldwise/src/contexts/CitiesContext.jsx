...
function CitiesProvider({ children }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                dispatch({ type: 'rejected', payload: 'An error on loading cities' });
            }
        };
        fetchData();
    }, []);
    ...
    const getCity = useCallback(
        async function getCity(id) {
            ...
            try {
                ...
                dispatch({ type: 'rejected', payload: 'An error on loading city' });
            }
        },
        [currentCity.id]
    );
    ...
    async function createCity(newCity) {
        ...
        try {
            ...
            dispatch({ type: 'rejected', payload: 'An error on creating city' });
        }
    }
    ...
    async function deleteCity(id) {
        ...
        try {
            ...
            dispatch({ type: 'rejected', payload: 'An error on deleting city' });
        }
    }
